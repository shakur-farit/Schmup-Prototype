...
public class Enemy : MonoBehaviour
{
    ...
    public EnemyMovementModes movementMode = EnemyMovementModes.FollowTarget;
    ...
    protected virtual Vector3 GetDesiredMovement()
    {
        ...
        switch (movementMode)
        {
            case EnemyMovementModes.FollowTarget:
                movement = GetFollowPlayerMovement();
                break;
            case EnemyMovementModes.Scroll:
    ...
    private Quaternion GetFollowPlayerRotation()
    {
        ...
        Quaternion rotationToTarget = Quaternion.Euler(0, 0, angle + 180);
